...
- feat: copy link and qrcode support
- feat: custom config enhance
- feat: screen capture enhance
- fix: Claude bugfix
...
- feat: Z.ai support
- feat: UX refine
- fix: Perplexity, Lambda Chat and Nami AI Search bugfix

## 1.8.4 [2025.07.01]

- fix: Perplexity and Liner bugfix
- fix: bugfix
